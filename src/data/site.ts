...
export const copy = {
  ...
  zh: {
    ...
    bio: '我是香港科技大学（广州）计算媒体与艺术方向的博士生，拥有香港科技大学（广州）计算媒体与艺术硕士学位，以及韩国延世大学媒体传播学学士学位。我的研究以创作者为中心的人机交互为核心，关注 AI 技术如何支持叙事内容创作、视觉创作、创意决策与故事生产流程。我的研究兴趣还包括人机协作、AI 在创意工作中的应用、社交媒体内容创作以及 AIGC。',
    education: '教育经历',
